        ...
        <div id="sidebar" class="col-auto col-md-3 col-xl-2 px-0 sidebar d-flex flex-column">
          ...
          <nav class="flex-grow-1">
            <ul class="nav flex-column pt-3">
              ...
              <li class="nav-item mb-2">
                <a class="nav-link" href="admin_questions.php">
                  <i class="bi bi-list-ul"></i> <span>Question List</span>
                </a>
              </li>
              <li class="nav-item mb-2">
                <a class="nav-link" href="addquestion.php">
                  <i class="bi bi-plus-circle"></i> <span>Ask a new question</span>
                </a>
              </li>
              <li class="nav-item mb-2">
                <a class="nav-link" href="admin_dm.php">
                  <i class="bi bi-envelope"></i> <span>Admin messages</span>
                </a>
              </li>
              <li class="nav-item mb-2">
                <a class="nav-link" href="admin_module.php">
                  <i class="bi bi-collection"></i> <span>Module List</span>
                </a>
              </li>
              <li class="nav-item mb-2">
                <a class="nav-link" href="addmodule.php">
                  <i class="bi bi-plus-square"></i> <span>Add a new module</span>
                </a>
              </li>
              <li class="nav-item mb-2">
              ...
              <li class="nav-item mb-2">
                <a class="nav-link" href="../login/Logout.php">
                  <i class="bi bi-box-arrow-right"></i> <span>Public site/Logout</span>
                </a>
              </li>
            </ul>
          </nav>
