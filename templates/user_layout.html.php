        ...
        <div id="sidebar" class="col-auto col-md-3 col-xl-2 px-0 sidebar d-flex flex-column">
          ...
          <nav class="flex-grow-1">
            <ul class="nav flex-column pt-3">
              ...
              <li class="nav-item mb-2">
                <a class="nav-link" href="user_questions.php">
                  <i class="bi bi-list-ul"></i> <span>Questions List</span>
                </a>
              </li>
              <li class="nav-item mb-2">
                <a class="nav-link" href="../user/user_addquestion.php">
                  <i class="bi bi-plus-circle"></i> <span>Ask a question</span>
                </a>
              </li>
              <li class="nav-item mb-2">
                <a class="nav-link" href="../user/user_dm.php">
                  <i class="bi bi-envelope"></i> <span>Admin Message</span>
                </a>
              </li>
              <li class="nav-item mb-2">
